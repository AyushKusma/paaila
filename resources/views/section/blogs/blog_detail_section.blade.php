<section class="blog-details pt-60 pb-120">
    <div class="container">
            ...
            <div class="col-lg-8">
                <div class="blog-details-top-wrap">
                    <div class="blog-details-top">
                        ...
                        <ul class="post-meta">
                            <li><i class="fa-sharp fa-solid fa-clock"></i>{{ $blog['date'] }}</li>
                            <li><i class="fa-sharp fa-solid fa-folder"></i>{{ $blog['category']['name'] }}</li>
                        </ul>
                    </div>
                    <div class="blog-details-content">
                        <h2 class="details-title">{{ $blog['name'] }}</h2>
                        @isset ($blog['description'])
                            <p class="mb-30">{!! str()->sanitizeHtml($blog['description']) !!}</p>
                        @else
                            <p class="mb-20">Uniquely pursue emerging experiences before liemerging content.
                                Efficiently
                            ...
                            <p class="mb-30">Assertively recaptiualize interdependent alignments via backend leadership
                                skills. Monotonectally formulate focused quality vectors whereas proactive
                                infomediaries.
                                Energistically utilize ethical initiatives without impactful applications.
                                Authoritatively
                                coordinate seamless e-services and user friendly information. Interactively initiate
                                optimal
                                resources before e-business expertise</p>
                            <blockquote>
                                <p>Compellingly administrate functional information alue added web services
                                    onotonectally
                                    repurpose interdependent technology whereas best-of-breed architectures.</p>
                                <h4 class="author">Ronald Richards</h4>
                            </blockquote>
                            <p class="mb-20">Appropriately mesh standards compliant communities vis-a-vis
                                client-centric
                                ...
                                pursue high-payoff outsourcing through sustainable web-readiness. Authoritatively
                                benchmark
                            ...
                            <div class="details-list-wrap">
                                ...
                                <div class="details-img">
                                    <img src="/images/blog-details-img-2.png" alt="">
                                </div>
                            </div>
                            <p class="mt-30 mb-20">Globally cultivate ubiquitous growth strategies before team building
                                users. Dramatically transform effective internal or "organic" sources for economically
                                sound
                            ...
                            <p>Globally cultivate ubiquitous growth strategies before team building users. Dramatically
                                ...
                                Completely seize seamless e-tailers whereas mission-critical ideas. Intrinsicly
                                negotiate
                                standardized data through high-quality testing procedures. Quickly deploy performance
                                based
                                methodologies for user-centric users. Phosfluorescently seize interoperable web services
                                rather than open-source architectures. Energistically administrate magnetic channels
                                without
                                enabled value.
                            </p>
                            <div class="tag-wrap">
                ...
                <div class="sidebar-widget">
                    ...
                    <ul class="category-list">
                        @forelse ($categories as $category)
                            <li><a href="#"><i
                                        class="fa-sharp fa-solid fa-circle-check"></i>{{ $category->name }}</a></li>
                        @empty
                            ...
                            <li><a href="#"><i class="fa-sharp fa-solid fa-circle-check"></i>Expert Teachers</a>
                            </li>
                            <li><a href="#"><i class="fa-sharp fa-solid fa-circle-check"></i>Extra Classes</a>
                            </li>
                ...
                <div class="sidebar-widget">
                    ...
                    @forelse ($recentBlogs as $recentBlog)
                        <div class="sidebar-post">
                            <img src="{{ $recentBlog['image_url'] }}" alt="{{ $recentBlog['name'] }}">
                            <div class="post-content">
                                <h3 class="title"><a href="#">{{ $recentBlog['name'] }}</a></h3>
                                <ul class="post-meta">
                                    <li><i class="fa-light fa-user"></i>By Admin</li>
                                    <li><i class="fa-sharp fa-solid fa-folder-open"></i>{{ $recentBlog['category']['name'] }}</li>
                                </ul>
                            </div>
                        </div>
                    @empty
