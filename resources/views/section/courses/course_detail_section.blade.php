                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                                    type="button" role="tab" aria-controls="profile" aria-selected="false"><i
                                        class="fa-solid fa-book"></i>Curriculam</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body">
                                                    <ul class="curri-list">
                                                        <li><span><i class="fa-solid fa-video"></i> Mastering
                                                                Pronunciation and Intonation</span> <span>54.23 <i
                                                                    class="fa-solid fa-unlock"></i></span></li>
                                                        <li><span><i class="fa-solid fa-video"></i> Building a Strong
                                                                Vocabulary for Everyday Communication</span> <span>45.05
                                                                <i class="fa-solid fa-unlock"></i></span></li>
                                                        <li><span><i class="fa-solid fa-file-contract"></i>
                                                                Understanding Basic Sentence Structure and
                                                                Grammar</span> <span>1.6hr <i
                                    ...
                                    <div class="review-list">
                                        <div class="review-item">
                                            <div class="review-thumb">
                                                <img src="/images/review-list-1.jpg" alt="img">
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="review-item">
                                            <div class="review-thumb">
                                                <img src="/images/review-list-2.jpg" alt="img">
                                            </div>
                                            <div class="content">
                                                <div class="content-top">
                                                ...
                                                <p>Designed very similarly to the nearly double priced Galaxy tab S6,
                                                    with the only removal being.Mauris non dignissim purus, ac commodo
                                                    diam. Donec sit amet lacinia nulla. Aliquam quis purus in justo
                                                    pulvinar tempor.</p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="col-xl-3 col-lg-12">
                ...
                <div class="course-sidebar sticky-widget">
                    ...
                    <ul class="course-sidebar-list">
                        ...
                        <li><i class="fa-solid fa-book"></i>Lessons: <span>8</span></li>
                        ...
                        <li><i class="fa-solid fa-globe"></i>Language: <span>English</span></li>
                        <li><i class="fa-solid fa-puzzle-piece"></i>Quizzes: <span>04</span></li>
                    </ul>
                    <div class="share-btn">
