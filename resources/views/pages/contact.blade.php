                        ...
                        <form action="{{ route('contact.send') }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="tel" class="form-control form-control-lg rounded-4" id="phone"
                                        name="phone" placeholder="+977 ">
                                </div>
                                <div class="col-12">
                                    <label for="message" class="form-label">Message</label>
                                    <textarea class="form-control form-control-lg rounded-4" id="message" name="message" rows="4"
